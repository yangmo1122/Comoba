...
<section id="registry" class="gift-registry" data-stellar-background-ratio="0.3" style="background-color: white;">
                ...
                <div class="row margin-b-50">
                    <div class="col-sm-8 col-sm-offset-2 text-center">
                        <div class="center-title">
                            <h2>공스토리 질문</h2>
                            <p>
                            GongStory 방입니다. 더 궁굼하신 내용은 1:1 상담 창을 눌러주세요.
                              </p>
                            <hr>
                        </div>
                    </div>
        ...
        <div class="divide80" ></div>
               ...
               <div class="col-md-7" style="margin-left: 90px; width: 1290px; ">
 				 ...
 				 <c:forEach var="qnavo" items="${qnastory}" varStatus="status"> 
                          <div class="panel panel-default">
                         
                            <div class="panel-heading">
                            
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse${status.index}"  style="color: gray;">
                                 <%-- ${question_no}  --%>    ${qnavo.title}
                                    </a>
                                </h4>
                            </div>
