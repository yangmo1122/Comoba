...
! function(a) {
    ...
    function la(a, c) {
        var d, e, f = !1,
            ...
            h = a.length,
            i = [];
        for (d = 0; h > d; d++) e = a[d], b.isMoment(e) || (e = Va.moment.parseZone(e)), f = f || e._ambigTime, g = g || e._ambigZone, i.push(e);
    ...
    function ta(a, b, c, d, e) {
        ...
        for (i = g; h >= i; i++) n += ra(a, c[i]), o += ra(b, c[i]);
    ...
    function La(a) {
        ...
        for (b = 0; b < a.length; b++)
            for (c = a[b], d = 0; d < c.length; d++)
                for (e = c[d], e.forwardSegs = [], f = b + 1; f < a.length; f++) Na(e, a[f], e.forwardSegs)
    }
    ...
    Va.Class = xa, xa.extend = function() {
        ...
        for (a = 0; c > a; a++) b = arguments[a], c - 1 > a && za(this, b);
        return ya(this, b || {})
    }, xa.mixin = function(a) {
        za(this, a)
    };
    ...
    var tb = Va.DayTableMixin = {
            ...
            renderHeadDateCellHtml: function(a, b, c) {
                var d = this.view;
                return '<th class="fc-day-header ' + d.widgetHeaderClass + " fc-" + Za[a.day()] + '"' + (1 == this.rowCnt ? ' data-date="' + a.format("YYYY-MM-DD") + '"' : "") + (b > 1 ? ' colspan="' + b + '"' : "") + (c ? " " + c : "") + "><a href='/main/myroom/caldetail.action?sm_fulldate=" + a.format()+ "'>"+ ca(a.format(this.colHeadFormat)) + "</a></th>";
            },
            ...
            renderBgCellHtml: function(a, b) {
                ...
                return d.unshift("fc-day", c.widgetContentClass), '<td class="' + d.join(" ") + '" data-date="' + a.format("YYYY-MM-DD") + '"' + (b ? " " + b : "") + "><div style='width:30%; display:inline;' id='detail_dday" + a.format("YYYY-MM-DD") + "' name='detail_dday" + a.format("YYYY-MM-DD") + "'>1</div><div style='width:30%; display:inline;' id='detail_sche" + a.format("YYYY-MM-DD") + "' name='detail_sche" + a.format("YYYY-MM-DD") + "'>2</div><div style='width:30%; display:inline;' id='mission" + a.format("YYYY-MM-DD") + "' name='mission" + a.format("YYYY-MM-DD") + "'>3</div></td>"  //caldetail 수정 부분
            },
        ...
        ub = Va.DayGrid = sb.extend(tb, {
            ...
            renderNumberCellHtml: function(a) {
                var b;
                return this.view.dayNumbersVisible ? (b = this.getDayClasses(a), b.unshift("fc-day-number"), '<td class="' + b.join(" ") + '" data-date="' + a.format() + '"value="' + a.format() + '">' + a.date() + "</td>") : "<td/>"
            },
            computeEventTimeFormat: function() {
    ...
    var vb = Va.TimeGrid = sb.extend(tb, {
        ...
        computeLabelInterval: function(a) {
            ...
            for (c = Mb.length - 1; c >= 0; c--)
                if (d = b.duration(Mb[c]), e = R(d, a), ha(e) && e > 1) return d;
            return b.duration(a)
        },
        computeEventTimeFormat: function() {
    ...
    var wb = Va.View = xa.extend(kb, lb, {
        ...
        xb = Va.Scroller = xa.extend({
            ...
            renderEl: function() {
                return this.scrollEl = a('<div ></div>')
            },
            clear: function() {
        ...
        yb = Va.Calendar = xa.extend({
            ...
            buildViewSpec: function(a) {
                for (var d, e, f, g, h = this.overrides.views || {}, i = [], j = [], k = [], l = a; l;) d = Wa[l], e = h[l], l = null, "function" == typeof d && (d = {
                    "class": d
    ...
    var Ib = Va.AgendaView = wb.extend({
            ...
            renderDates: function() {
                ...
                var //b = this.scroller.el.addClass("sm-content");
                    c = a('<div class="fc-center"/>').appendTo("<br>");
