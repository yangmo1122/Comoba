...
! function(a) {
    ...
    var tb = Va.DayTableMixin = {
        ...
        ub = Va.DayGrid = sb.extend(tb, {
            ...
            renderNumberCellHtml: function(a) {
                var b;
                return this.view.dayNumbersVisible ? (b = this.getDayClasses(a), b.unshift("fc-day-number"), '<td class="fc_daynum'+a.date()+' ' + b.join(" ") + '" data-date="' + a.format() +'" ><span style="float:left; margin-left: 3.5px; "><a href="/main/myroom/caldetail.action?sm_fulldate=' + a.format()+ '">' + a.date() + "</a></span><span style='float:left;' id='" + a.format() +"'></span><a data-toggle='modal' data-target='#calwrite' data-dismiss='modal'><span class='sm_cal_edit' id= 'fc_daynum"+a.format()+"' data-clickcal='"+a.format()+" 'style='float: right'><img src='/main/resources/img/sm/edit.png' width='auto;' height='17px;'></span></td>") : "<td/>"
            },
            computeEventTimeFormat: function() {
            ...
            if (c && c < u.segLevels.length) {
                for (e = u.segLevels[c - 1], f = u.cellMatrix, g = u.tbodyEl.children().slice(c).addClass("fc-limited").get(), h = 0; h < e.length; h++) {
                    ...
                    if (k) {
                        ...
                        m.addClass("fc-limited").after(a(o)), g.push(m[0])							//여기야.... ㅠ m = f[c - 1] 랑  l.length 잘봐봐...ㅠ
                    }
                }
    ...
    yb.mixin(kb), yb.defaults = {
        ...
        eventOrder: "title",
        eventLimit: !1,
        eventLimitText: "more",  // more 글써주는데....ㅠㅠ
