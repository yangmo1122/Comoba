...
public interface InterOurroomDAO {
	...
	/*
	 * void setAddReadCount(String board_no);// 글 조회수 1증가 BoardVO getView(String
	 * board_no); // 글 1개를 보여주는것
	 */
	...
	List<String> getnickname(List<CommentVO> commentList); // commetList
															// meberno_fk 를 가지고
															// 닉네임 가져오기
	...
	List<HashMap<String, String>> getStudyroom(); // 스터디룸 가져오기

	List<HashMap<String, String>> searchmarkerList(HashMap<String, String> map);
